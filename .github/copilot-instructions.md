...
Before planning or implementing non-trivial changes, consult `d:/inbox` for relevant user-provided knowledge.
Use applicable information from `d:/inbox` alongside repository documentation.
