...
GitHub Issues are the source of truth for issues and PRDs in this repo (via gh); external PRs are not a triage surface. See docs/agents/issue-tracker.md.
...
Domain docs are single-context (root CONTEXT.md and root .devdrive/docs/adr/). See docs/agents/domain.md.
